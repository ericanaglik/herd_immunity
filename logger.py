class Logger(object):
    ...
    def write_metadata(self, pop_size, vacc_percentage, virus_name, mortality_rate,
        ...
        file.write("Population size: " + population_size + "\t Vacc Percentage: " + vacc_percentage + "\t Virus Name: "+ virus_name + "\t Mortality Rate: " + mortality_rate + "\t Infection Rate: " + infection_rate + "\n")
    ...
    def log_interaction(self, person1, person2, did_infect=None,
        ...
        # taken from https://github.com/DrakeVorndran/CS-1.1-Programming-Fundamentals/blob/master/Herd_Immunity_Project/logger.py
        if(did_infect):
    ...
    def log_infection_survival(self, person, did_die_from_infection):
        ...
        if did_die_from_infection:
            file.write("Person " + str(person._id) + " has died. \n")
        else:
    ...
    def log_time_step(self, time_step_number):
        ...
        # event logged ends up on a separate line!
        file = open(self.file_name, "a")
        file.write("Beginning of time step: " + str(time_step_number)+ "\n")
